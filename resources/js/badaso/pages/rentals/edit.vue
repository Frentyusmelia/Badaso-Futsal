                        ...
                        <vs-row>
                            <vs-col vs-lg="12">
                                ...
                                >
                                    ...
                                    <strong>{{
                                        $t("offlineFeature.dataUpdatePending")
                                    }}</strong>
                                </vs-button>
                            </vs-col>
                        </vs-row>
                        ...
                        <vs-row>
                            <vs-col vs-lg="12">
                                <h3>
                                    {{
                                        $t(
                                            "crudGenerated.warning.notAllowedToEdit",
                                            {
                                                tableName:
                    ...
                    try {
                        ...
                        if (
                            ...
                            let destinationTableId =
                                data.relation.destinationTable + "Id";
                            data.value = [];
                            Object.entries(record).filter(function (item, key) {
                                return (data.value[key] =
                                    item[1][destinationTableId]);
                            });
                        } else {
                            data.value =
                                this.record[
